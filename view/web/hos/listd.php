...
$responseData = $client->get('/controller/DoctorController.php', [
    'ope' => 'filterSearch',
    'page' => $page,
    'busqueda' => $filter,
]);
...
<head>
    <title>Doctores Registrados</title>
    <style>
        h5 {
            font-weight: bold;
            text-align: center;
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-header">
                    <a href="<?php echo HTTP_BASE; ?>/web/hos/newd/0" 
                    class="btn btn-primary">Nuevo</a>
                    <a href="<?php echo HTTP_BASE; ?>/report/rptdoctor.php" 
                    target="_blank"
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="<?php echo HTTP_BASE . "/web/hos/viewd/" . $row['iddoctor']; ?>" class="btn btn-success btn-sm">Ver</a>
                                    <a href="<?php echo HTTP_BASE . "/web/hos/editd/" . $row['iddoctor']; ?>" class="btn btn-primary btn-sm">Editar</a>
                                    <a href="<?php echo HTTP_BASE . "/web/hos/deleted/" . $row['iddoctor']; ?>" class="btn btn-danger btn-sm">Eliminar</a>
                                </td>
